...
namespace MVCDemo2.Controllers
{
    public class ClientesController : Controller
    {
        ...
        //// GET: Contratos/ContratosdoCliente/5
        ...
        //    if (contrato.Count == 0)
        //    {
        //       return View("ClienteNaoEncontrado");
        //    }
        ...
        public ActionResult Create([Bind(Include = "Id,Nome,Endereco,Cidade,Estado")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nome,Endereco,Cidade,Estado")] Cliente cliente)
        {
            if (ModelState.IsValid)
            {
